    ...
    return `
        ...
        <div class="settings-content">
            <header class="settings-header">
                ...
                <div class="header-welcome" id="header-welcome">
                    ...
                    <div class="header-actions">
                        <a href="https://github.com/migsilva89/MarkMind" target="_blank" rel="noopener noreferrer" class="github-star-btn">
            ...
            <footer class="settings-footer">
                ...
                <a href="https://github.com/migsilva89/MarkMind/issues" target="_blank" class="footer-bug-link">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" width="12" height="12">
